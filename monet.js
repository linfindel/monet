      ...
      reader.onload = function (e) {
        ...
        generateMaterialDesignPalette(fileURL, (error, palette) => {
          if (error) {
            ...
            document.getElementById("accent").style.backgroundColor =
              palette.accent;
            document.getElementById("primary").style.backgroundColor =
              palette.primary;
            document.getElementById("primaryDark").style.backgroundColor =
              palette.primaryDark;
            document.getElementById("primaryLight").style.backgroundColor =
              palette.primaryLight;

            document.getElementById("accent").innerText = palette.accent;
            document.getElementById("primary").innerText = palette.primary;
            document.getElementById("primaryDark").innerText =
              palette.primaryDark;
            document.getElementById("primaryLight").innerText =
              palette.primaryLight;
            ...
            document.getElementById("accent-trans").style.backgroundColor =
              generateRGBA(palette.accent, 0.25);
            document.getElementById("primary-trans").style.backgroundColor =
              generateRGBA(palette.primary, 0.25);
            document.getElementById("primaryDark-trans").style.backgroundColor =
              generateRGBA(palette.primaryDark, 0.25);
            document.getElementById(
              "primaryLight-trans"
            ).style.backgroundColor = generateRGBA(palette.primaryLight, 0.25);

            document.getElementById("accent-trans").innerText = rgbaToHex(
              generateRGBA(palette.accent, 0.25)
            );
            document.getElementById("primary-trans").innerText = rgbaToHex(
              generateRGBA(palette.primary, 0.25)
            );
            document.getElementById("primaryDark-trans").innerText = rgbaToHex(
              generateRGBA(palette.primaryDark, 0.25)
            );
            document.getElementById("primaryLight-trans").innerText = rgbaToHex(
              generateRGBA(palette.primaryLight, 0.25)
            );

            document.getElementById(
              "accent-trans-inter"
            ).style.backgroundColor = generateRGBA(palette.accent, 0.5);
            document.getElementById(
              "primary-trans-inter"
            ).style.backgroundColor = generateRGBA(palette.primary, 0.5);
            document.getElementById(
              "primaryDark-trans-inter"
            ).style.backgroundColor = generateRGBA(palette.primaryDark, 0.5);
            document.getElementById(
              "primaryLight-trans-inter"
            ).style.backgroundColor = generateRGBA(palette.primaryLight, 0.5);

            document.getElementById("accent-trans-inter").innerText = rgbaToHex(
              generateRGBA(palette.accent, 0.5)
            );
            document.getElementById("primary-trans-inter").innerText =
              rgbaToHex(generateRGBA(palette.primary, 0.5));
            document.getElementById("primaryDark-trans-inter").innerText =
              rgbaToHex(generateRGBA(palette.primaryDark, 0.5));
            document.getElementById("primaryLight-trans-inter").innerText =
              rgbaToHex(generateRGBA(palette.primaryLight, 0.5));

            document.getElementById("navbar").style.backgroundColor =
              generateRGBA(palette.accent, 0.25);
            document.getElementById("uploadLinkButton").style.backgroundColor =
              generateRGBA(palette.accent, 0.25);
            document.getElementById("uploadFileButton").style.backgroundColor =
              generateRGBA(palette.accent, 0.25);
            document.getElementById("export").style.backgroundColor =
              generateRGBA(palette.accent, 0.25);

            document
              .getElementById("uploadLinkButton")
            ...
            document
              ...
              .addEventListener("mouseout", () => {
                document.getElementById(
                  "uploadLinkButton"
                ).style.backgroundColor = generateRGBA(palette.accent, 0.25);
              });
...
function openLink() {
  ...
  generateMaterialDesignPalette(imageURL, (error, palette) => {
    if (error) {
      ...
      document.getElementById("primaryDark-trans").style.backgroundColor =
        generateRGBA(palette.primaryDark, 0.25);
      document.getElementById("primaryLight-trans").style.backgroundColor =
        generateRGBA(palette.primaryLight, 0.25);
      ...
      document.getElementById("accent-trans-inter").style.backgroundColor =
        generateRGBA(palette.accent, 0.5);
      document.getElementById("primary-trans-inter").style.backgroundColor =
        generateRGBA(palette.primary, 0.5);
      document.getElementById("primaryDark-trans-inter").style.backgroundColor =
        generateRGBA(palette.primaryDark, 0.5);
      document.getElementById(
        "primaryLight-trans-inter"
      ).style.backgroundColor = generateRGBA(palette.primaryLight, 0.5);
      ...
      document.getElementById("primary-trans-inter").innerText = rgbaToHex(
        generateRGBA(palette.primary, 0.5)
      );
      document.getElementById("primaryDark-trans-inter").innerText = rgbaToHex(
        generateRGBA(palette.primaryDark, 0.5)
      );
      document.getElementById("primaryLight-trans-inter").innerText = rgbaToHex(
        generateRGBA(palette.primaryLight, 0.5)
      );

      document.getElementById("navbar").style.backgroundColor = generateRGBA(
        palette.accent,
        0.25
      );
      document.getElementById("uploadLinkButton").style.backgroundColor =
        generateRGBA(palette.accent, 0.25);
      document.getElementById("export").style.backgroundColor = generateRGBA(
        palette.accent,
        0.25
      );
    ...
    .then((data) => {
      ...
      navigator.clipboard
        ...
        .then(() => {
          ...
          document.getElementById("export-text").innerText =
            "CSS copied to clipboard";

          setTimeout(() => {
            document.getElementById("export-icon").innerText = "export_notes";
            document.getElementById("export-text").innerText =
              "Export as custom NadirCSS";
          }, 3000);
        })
        .catch((error) => {
